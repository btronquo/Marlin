...
#define MSG_LEDS_ON                         _UxGT("SvÄ›tla Zap")
#define MSG_LEDS_OFF                        _UxGT("SvÄ›tla Vyp")
#define MSG_LED_PRESETS                     _UxGT("SvÄ›tla PÅ™edvolby")
#define MSG_SET_LEDS_RED                    _UxGT("SvÄ›tla ÄŒervenÃ¡")
#define MSG_SET_LEDS_ORANGE                 _UxGT("SvÄ›tla OranÅ¾ovÃ¡")
#define MSG_SET_LEDS_YELLOW                 _UxGT("SvÄ›tla Å½lutÃ¡")
#define MSG_SET_LEDS_GREEN                  _UxGT("SvÄ›tla ZelenÃ¡")
#define MSG_SET_LEDS_BLUE                   _UxGT("SvÄ›tla ModrÃ¡")
#define MSG_SET_LEDS_INDIGO                 _UxGT("SvÄ›tla Indigo")
#define MSG_SET_LEDS_VIOLET                 _UxGT("SvÄ›tla FialovÃ¡")
#define MSG_SET_LEDS_WHITE                  _UxGT("SvÄ›tla BÃ­lÃ¡")
#define MSG_SET_LEDS_DEFAULT                _UxGT("SvÄ›tla VÃ½chozÃ­")
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("JeÅ¡tÄ› vytlaÄ�it")
