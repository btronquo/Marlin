...
#define MSG_RESUMING                        _UxGT("Î£Ï…Î½ÎµÏ‡Î¯Î¶ÎµÏ„Î±Î¹ Î· ÎµÎºÏ„Ï�Ï€Ï‰ÏƒÎ·") //SHORTEN
...
#define MSG_HEATING_COMPLETE                _UxGT("Î— Î¸Î­Ï�Î¼Î±Î½ÏƒÎ· Î¿Î»Î¿ÎºÎ»Î·Ï�ÏŽÎ¸Î·ÎºÎµ.") //SHORTEN
#define MSG_BED_HEATING                     _UxGT("Î˜Î­Ï�Î¼Î±Î½ÏƒÎ· Î•Î . Î•ÎºÏ„Ï�Ï€Ï‰ÏƒÎ·Ï‚") //SHORTEN
#define MSG_BED_DONE                        _UxGT("Î— Î•Ï€. Î•ÎºÏ„Ï�Ï€Ï‰ÏƒÎ·Ï‚ Î¿Î»Î¿ÎºÎ»Î·Ï�ÏŽÎ¸Î·ÎºÎµ") //SHORTEN
