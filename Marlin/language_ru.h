...
#define MSG_LCD_ENDSTOPS                    _UxGT("ÐšÐ¾Ð½Ñ†ÐµÐ²Ð¸ÐºÐ¸")
...
#define MSG_AUTO_HOME                       _UxGT("Ð�Ð²Ñ‚Ð¾ ÐŸÐ°Ñ€ÐºÐ¾Ð²ÐºÐ°")
...
#define MSG_LEVEL_BED_HOMING                _UxGT("Ð�ÑƒÐ»ÐµÐ²Ð¾Ðµ Ð¿Ð¾Ð»Ð¾Ð¶")
#define MSG_LEVEL_BED_WAITING               _UxGT("Ð�Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ Ð½Ð°Ñ‡Ð°Ñ‚ÑŒ")
...
#define MSG_HOME_OFFSETS_APPLIED            _UxGT("ÐšÐ¾Ñ€Ñ€ÐµÐºÑ†Ð¸Ð¸ Ð¿Ñ€Ð¸Ð¼ÐµÐ½")
...
#define MSG_PREHEAT_1_END                   MSG_PREHEAT_1 _UxGT(" Ð¡Ð¾Ð¿Ð»Ð¾")
#define MSG_PREHEAT_1_BEDONLY               MSG_PREHEAT_1 _UxGT(" Ð¡Ñ‚Ð¾Ð»")
...
#define MSG_PREHEAT_2_END                   MSG_PREHEAT_2 _UxGT(" Ð¡Ð¾Ð¿Ð»Ð¾")
#define MSG_PREHEAT_2_BEDONLY               MSG_PREHEAT_2 _UxGT(" Ð¡Ñ‚Ð¾Ð»")
#define MSG_PREHEAT_2_SETTINGS              MSG_PREHEAT_2 _UxGT(" Ð�Ð°Ñ�Ñ‚Ñ€.")
#define MSG_COOLDOWN                        _UxGT("ÐžÑ…Ð»Ð°Ð¶Ð´ÐµÐ½Ð¸Ðµ")
#define MSG_SWITCH_PS_ON                    _UxGT("Ð’ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ ÐŸÐ¸Ñ‚Ð°Ð½Ð¸Ðµ")
#define MSG_SWITCH_PS_OFF                   _UxGT("ÐžÑ‚ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ ÐŸÐ¸Ñ‚Ð°Ð½Ð¸Ðµ")
...
#define MSG_BED_LEVELING                    _UxGT("ÐšÐ°Ð»Ð¸Ð±Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ñ�Ñ‚Ð¾Ð»")
...
#define MSG_UBL_DEACTIVATE_MESH             _UxGT("Ð’Ñ‹ÐºÐ»ÑŽÑ‡Ð¸Ñ‚ÑŒ UBL")
...
#define MSG_UBL_FINE_TUNE_MESH              _UxGT("Ð¢Ð¾Ñ‡. Ð½Ð°Ñ�Ñ‚Ñ€Ð¾Ð¹ÐºÐ° Ñ�ÐµÑ‚ÐºÐ¸")
...
#define MSG_UBL_INFO_UBL                    _UxGT("Ð’Ñ‹Ð´Ð°Ñ‡Ð° Ð¸Ð½Ñ„Ð¾Ñ€. UBL")
#define MSG_UBL_EDIT_MESH_MENU              _UxGT("Ð ÐµÐ´Ð°ÐºÑ‚Ð¸Ñ€Ð¾Ð²Ð°Ñ‚ÑŒ Ñ�ÐµÑ‚ÐºÑƒ")
#define MSG_UBL_FILLIN_AMOUNT               _UxGT("Ð—Ð°Ð¿Ð¾Ð»Ð½Ð¸Ñ‚ÑŒ Ð·Ð½Ð°Ñ‡ÐµÐ½Ð¸Ñ�")
#define MSG_UBL_MANUAL_FILLIN               _UxGT("Ð ÑƒÑ‡Ð½Ð¾Ðµ Ð·Ð°Ð¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ðµ")
#define MSG_UBL_SMART_FILLIN                _UxGT("Ð£Ð¼ÐµÐ½Ð¾Ðµ Ð·Ð°Ð¿Ð¾Ð»Ð½ÐµÐ½Ð¸Ðµ")
...
#define MSG_UBL_FINE_TUNE_ALL               _UxGT("Ð¢Ð¾Ñ‡. Ð½Ð°Ñ�Ñ‚Ñ€Ð¾Ð¹ÐºÐ° Ð²Ñ�ÐµÐ³Ð¾")
...
#define MSG_UBL_LOAD_MESH                   _UxGT("Ð—Ð°Ð³Ñ€ÑƒÐ·Ð¸Ñ‚ÑŒ Ñ�Ñ‚Ð¾Ð» Ñ�ÐµÑ‚ÐºÐ¸")
#define MSG_UBL_SAVE_MESH                   _UxGT("Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ñ�Ñ‚Ð¾Ð» Ñ�ÐµÑ‚ÐºÐ¸")
#define MSG_UBL_SAVE_ERROR                  _UxGT("ÐžÑˆÐ¸Ð±ÐºÐ°: Ð¡Ð¾Ñ…Ñ€. UBL")
#define MSG_UBL_RESTORE_ERROR               _UxGT("ÐžÑˆÐ¸Ð±ÐºÐ°: Ð—Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸ UBL")
#define MSG_UBL_Z_OFFSET_STOPPED            _UxGT("Ð¡Ð¼ÐµÑ‰ÐµÐ½Ð¸Ðµ Z Ð¾Ñ�Ñ‚Ð°Ð½Ð¾Ð².")
#define MSG_UBL_STEP_BY_STEP_MENU           _UxGT("ÐŸÐ¾ÑˆÐ°Ð³Ð¾Ð²Ñ‹Ð¹ UBL")
...
#define MSG_MOVE_01MM                       _UxGT("Ð”Ð²Ð¸Ð¶ÐµÐ½Ð¸Ðµ 0.1mm")
#define MSG_MOVE_1MM                        _UxGT("Ð”Ð²Ð¸Ð¶ÐµÐ½Ð¸Ðµ 1mm")
#define MSG_MOVE_10MM                       _UxGT("Ð”Ð²Ð¸Ð¶ÐµÐ½Ð¸Ðµ 10mm")
#define MSG_SPEED                           _UxGT("Ð¡ÐºÐ¾Ñ€Ð¾Ñ�Ñ‚ÑŒ")
#define MSG_BED_Z                           _UxGT("Z Ñ�Ñ‚Ð¾Ð»Ð°")
#define MSG_NOZZLE                          LCD_STR_THERMOMETER _UxGT(" Ð¡Ð¾Ð¿Ð»Ð¾")
#define MSG_BED                             LCD_STR_THERMOMETER _UxGT(" Ð¡Ñ‚Ð¾Ð»")
...
#define MSG_VELOCITY                        _UxGT("Ð¡ÐºÐ¾Ñ€Ð¾Ñ�Ñ‚ÑŒ")
...
#define MSG_XSTEPS                          _UxGT("X ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_YSTEPS                          _UxGT("Y ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_ZSTEPS                          _UxGT("Z ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_ESTEPS                          _UxGT("E ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_E1STEPS                         _UxGT("E1 ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_E2STEPS                         _UxGT("E2 ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_E3STEPS                         _UxGT("E3 ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_E4STEPS                         _UxGT("E4 ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_E5STEPS                         _UxGT("E5 ÑˆÐ°Ð³/Ð¼Ð¼")
#define MSG_TEMPERATURE                     _UxGT("Ð¢ÐµÐ¼Ð¿ÐµÑ€Ð°Ñ‚ÑƒÑ€Ð°")
#define MSG_MOTION                          _UxGT("ÐœÐµÑ…Ð°Ð½Ð¸ÐºÐ°")
#define MSG_FILAMENT                        _UxGT("ÐŸÑ€ÑƒÑ‚Ð¾Ðº")
#define MSG_VOLUMETRIC_ENABLED              _UxGT("E Ð² mm3")
#define MSG_FILAMENT_DIAM                   _UxGT("Ð”Ð¸Ð°Ð¼ÐµÑ‚Ñ€ Ð¿Ñ€ÑƒÑ‚ÐºÐ°")
#define MSG_ADVANCE_K                       _UxGT("K Ð¿Ñ€Ð¾Ð´Ð²Ð¸Ð¶ÐµÐ½Ð¸Ñ�")
#define MSG_CONTRAST                        _UxGT("ÐšÐ¾Ð½Ñ‚Ñ€Ð°Ñ�Ñ‚ LCD")
#define MSG_STORE_EEPROM                    _UxGT("Ð¡Ð¾Ñ…Ñ€Ð°Ð½Ð¸Ñ‚ÑŒ Ð² EEPROM")
#define MSG_LOAD_EEPROM                     _UxGT("Ð¡Ñ‡Ð¸Ñ‚Ð°Ñ‚ÑŒ Ð¸Ð· EEPROM")
#define MSG_RESTORE_FAILSAFE                _UxGT("Ð¡Ð±Ñ€Ð¾Ñ� EEPROM")
#define MSG_INIT_EEPROM                     _UxGT("Ð˜Ð½Ð¸Ñ†. EEPROM")
#define MSG_REFRESH                         _UxGT("ÐžÐ±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ")
#define MSG_WATCH                           _UxGT("ÐžÐ±Ð·Ð¾Ñ€")
...
#define MSG_CARD_MENU                       _UxGT("ÐžÐ±Ð·Ð¾Ñ€ ÐºÐ°Ñ€Ñ‚Ñ‹")
#define MSG_NO_CARD                         _UxGT("Ð�ÐµÑ‚ ÐºÐ°Ñ€Ñ‚Ñ‹")
#define MSG_DWELL                           _UxGT("Ð¡Ð¾Ð½...")
#define MSG_USERWAIT                        _UxGT("ÐŸÑ€Ð¾Ð´Ð¾Ð»Ð¶Ð¸Ñ‚ÑŒ...")
#define MSG_PRINT_PAUSED                    _UxGT("ÐŸÐµÑ‡Ð°Ñ‚ÑŒ Ð¾Ñ�Ñ‚Ð°Ð½Ð¾Ð²Ð»ÐµÐ½Ð°")
#define MSG_RESUMING                        _UxGT("Ð’Ð¾Ð·Ð¾Ð±Ð½Ð¾Ð²Ð»ÐµÐ½Ð¸Ðµ...")
#define MSG_PRINT_ABORTED                   _UxGT("ÐžÑ‚Ð¼ÐµÐ½Ð° Ð¿ÐµÑ‡Ð°Ñ‚Ð¸")
...
#define MSG_CONTROL_RETRACT                 _UxGT("Ð’Ñ‚Ñ�Ð³Ð¸Ð²Ð°Ð½Ð¸Ðµ mm")
#define MSG_CONTROL_RETRACT_SWAP            _UxGT("Ð’Ñ‚Ñ�Ð³. Ñ�Ð¼ÐµÐ½Ñ‹ mm")
#define MSG_CONTROL_RETRACTF                _UxGT("Ð’Ñ‚Ñ�Ð³Ð¸Ð²Ð°Ð½Ð¸Ðµ V")
#define MSG_CONTROL_RETRACT_ZLIFT           _UxGT("Ð’Ñ‚Ñ�Ð³. Ð¿Ñ€Ñ‹Ð¶ÐºÐ° mm")
#define MSG_CONTROL_RETRACT_RECOVER         _UxGT("Ð’Ð¾Ð·Ð²Ñ€Ð°Ñ‚ mm")
#define MSG_CONTROL_RETRACT_RECOVER_SWAP    _UxGT("Ð’Ð¾Ð·Ð²Ñ€Ð°Ñ‚ Ñ�Ð¼ÐµÐ½Ñ‹ mm")
#define MSG_CONTROL_RETRACT_RECOVERF        _UxGT("Ð’Ð¾Ð·Ð²Ñ€Ð°Ñ‚  V")
#define MSG_AUTORETRACT                     _UxGT("Ð�Ð²Ñ‚Ð¾ Ð’Ñ‚Ñ�Ð³Ð¸Ð²Ð°Ð½Ð¸Ðµ")
#define MSG_FILAMENTCHANGE                  _UxGT("Ð¡Ð¼ÐµÐ½Ð° Ð¿Ñ€ÑƒÑ‚ÐºÐ°")
#define MSG_INIT_SDCARD                     _UxGT("Ð˜Ð½Ð¸Ñ†. ÐºÐ°Ñ€Ñ‚Ñƒ")
#define MSG_CNG_SDCARD                      _UxGT("Ð¡Ð¼ÐµÐ½Ð¸Ñ‚ÑŒ ÐºÐ°Ñ€Ñ‚Ñƒ")
...
#define MSG_HOME                            _UxGT("ÐŸÐ°Ñ€ÐºÑƒÐ¹")
...
#define MSG_ERR_REDUNDANT_TEMP              _UxGT("ÐžÑˆÐ¸Ð±ÐºÐ°: T Ñ€ÐµÐ´.")
#define MSG_THERMAL_RUNAWAY                 _UxGT("Ð¢Ð•ÐŸÐ›Ðž Ð£Ð‘Ð•Ð“Ð�Ð�Ð˜Ð¯!")
#define MSG_ERR_MAXTEMP                     _UxGT("ÐžÑˆÐ¸Ð±ÐºÐ°: Ð¢ Ð¼Ð°ÐºÑ�.")
#define MSG_ERR_MINTEMP                     _UxGT("ÐžÑˆÐ¸Ð±ÐºÐ°: Ð¢ Ð¼Ð¸Ð½.")
#define MSG_ERR_MAXTEMP_BED                 _UxGT("ÐžÑˆÐ¸Ð±ÐºÐ°:Ð¢ Ð¼Ð°ÐºÑ�.Ñ�Ñ‚Ð¾Ð»")
#define MSG_ERR_MINTEMP_BED                 _UxGT("ÐžÑˆÐ¸Ð±ÐºÐ°:Ð¢ Ð¼Ð¸Ð½.Ñ�Ñ‚Ð¾Ð»")
#define MSG_ERR_Z_HOMING                    _UxGT("G28 Z Ð—Ð°Ð¿Ñ€ÐµÑ‰ÐµÐ½Ð¾")
#define MSG_HALTED                          _UxGT("ÐŸÐ Ð˜Ð�Ð¢Ð•Ð  ÐžÐ¡Ð¢Ð�Ð�ÐžÐ’Ð›Ð•Ð�")
#define MSG_PLEASE_RESET                    _UxGT("Ð�Ð°Ð¶Ð¼Ð¸Ñ‚Ðµ Ñ€ÐµÑ�ÐµÑ‚")
...
#define MSG_HEATING                         _UxGT("Ð�Ð°Ð³Ñ€ÐµÐ²Ð°ÑŽ Ñ�Ð¾Ð¿Ð»Ð¾...")
#define MSG_HEATING_COMPLETE                _UxGT("Ð�Ð°Ð³Ñ€ÐµÐ² Ð²Ñ‹Ð¿Ð¾Ð»Ð½ÐµÐ½")
#define MSG_BED_HEATING                     _UxGT("Ð�Ð°Ð³Ñ€ÐµÐ²Ð°ÑŽ Ñ�Ñ‚Ð¾Ð»")
#define MSG_BED_DONE                        _UxGT("Ð¡Ñ‚Ð¾Ð» Ñ€Ð°Ð·Ð¾Ð³Ñ€ÐµÑ‚")
...
#define MSG_DELTA_SETTINGS                  _UxGT("ÐŸÐ¾Ðº. Ð½Ð°Ñ�Ñ‚Ñ€Ð¾Ð¹ÐºÐ¸ Delta")
...
#define MSG_CASE_LIGHT                      _UxGT("ÐšÐ¾Ñ€Ð¿ÑƒÑ�Ð½Ð¾Ðµ Ð¾Ñ�Ð²ÐµÑ‰ÐµÐ½Ð¸Ðµ")
#define MSG_CASE_LIGHT_BRIGHTNESS           _UxGT("Ð¯Ñ€ÐºÐ¾Ñ�Ñ‚ÑŒ Ð¾Ñ�Ð²ÐµÑ‰ÐµÐ½Ð¸Ñ�")
#if LCD_WIDTH >= 20
  #define MSG_INFO_COMPLETED_PRINTS         _UxGT("Ð—Ð°ÐºÐ¾Ð½Ñ‡ÐµÐ½Ð¾")
  #define MSG_INFO_PRINT_TIME               _UxGT("ÐŸÐ¾Ð»Ð½Ð¾Ðµ Ð²Ñ€ÐµÐ¼Ñ� Ð¿ÐµÑ‡Ð°Ñ‚Ð¸")
...
#define MSG_DAC_EEPROM_WRITE                _UxGT("Ð—Ð°Ð¿Ð¸Ñ�Ð¸ DAC EEPROM")
#define MSG_FILAMENT_CHANGE_HEADER          _UxGT("ÐŸÐ•Ð§Ð�Ð¢Ð¬ ÐžÐ¡Ð¢Ð�Ð�ÐžÐ’Ð›Ð•Ð�Ð�")
#define MSG_FILAMENT_CHANGE_OPTION_HEADER   _UxGT("ÐžÐŸÐ¦Ð˜Ð˜ Ð’ÐžÐ—ÐžÐ‘Ð�ÐžÐ’Ð›Ð•Ð�Ð˜Ð¯:")
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Ð’Ñ‹Ð´Ð°Ð²Ð¸Ñ‚ÑŒ ÐµÑ‰Ñ‘")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Ð’Ð¾Ð·Ð¾Ð±Ð½Ð¾Ð²Ð¸Ñ‚ÑŒ Ð¿ÐµÑ‡Ð°Ñ‚ÑŒ")
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("ÐœÐ¸Ð½. Ñ‚ÐµÐ¼Ð¿ÐµÑ€Ð°Ñ‚ÑƒÑ€Ð°")
...
//
  ...
  #define MSG_FILAMENT_CHANGE_UNLOAD_2    _UxGT("Ð²Ñ‹Ð³Ñ€ÑƒÐ·ÐºÐ¸ Ñ„Ð¸Ð»Ð°Ð¼ÐµÐ½Ñ‚Ð°")
  #define MSG_FILAMENT_CHANGE_INSERT_1    _UxGT("Ð’Ñ�Ñ‚Ð°Ð²ÑŒÑ‚Ðµ Ñ„Ð¸Ð»Ð°Ð¼ÐµÐ½Ñ‚")
  ...
  #define MSG_FILAMENT_CHANGE_LOAD_2      _UxGT("Ð·Ð°Ð³Ñ€ÑƒÐ·ÐºÐ¸ Ñ„Ð¸Ð»Ð°Ð¼ÐµÐ½Ñ‚Ð°")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1   _UxGT("Ð’Ñ‹Ð´Ð°Ð²Ð»Ð¸Ð²Ð°Ð½Ð¸Ðµ...")
