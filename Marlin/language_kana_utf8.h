...
#define MSG_VX_JERK                         _UxGT("Xã‚¸ã‚¯ ãƒ¤ã‚¯ãƒ‰ mm/s")             // "Vx-jerk"
#define MSG_VY_JERK                         _UxGT("Yã‚¸ã‚¯ ãƒ¤ã‚¯ãƒ‰ mm/s")             // "Vy-jerk"
#define MSG_VZ_JERK                         _UxGT("Zã‚¸ã‚¯ ãƒ¤ã‚¯ãƒ‰ mm/s")             // "Vz-jerk"
...
#define MSG_RESUMING                        _UxGT("ãƒ—ãƒªãƒ³ãƒˆã‚µã‚¤ã‚«ã‚¤")                // "Resuming print"
...
#define MSG_HEATING_COMPLETE                _UxGT("ã‚«ãƒ�ãƒ„ã‚«ãƒ³ãƒªãƒ§ã‚¦")                 // "Heating done."
#define MSG_BED_HEATING                     _UxGT("ãƒ™ãƒƒãƒ‰ ã‚«ãƒ�ãƒ„ãƒ�ãƒ¥ã‚¦")              // "Bed Heating."
#define MSG_BED_DONE                        _UxGT("ãƒ™ãƒƒãƒ‰ ã‚«ãƒ�ãƒ„ã‚«ãƒ³ãƒªãƒ§ã‚¦")            // "Bed done."
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("ã‚µãƒ©ãƒ‹ã‚ªã‚·ãƒ€ã‚¹")                 // "Extrude more"
...
#define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("ãƒ•ã‚£ãƒ©ãƒ¡ãƒ³ãƒˆã‚ªã‚·ãƒ€ã‚·ãƒ�ãƒ¥ã‚¦")          // "Wait for"
#define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("ã‚·ãƒ�ãƒ©ã‚¯ã‚ªãƒžãƒ�ã‚¯ãƒ€ã‚µã‚¤")            // "filament extrude"
