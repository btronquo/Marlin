...
#define MSG_RESUMING                        _UxGT("BaskÄ± SÃ¼rdÃ¼rÃ¼lÃ¼yor")                                 // BaskÄ± SÃ¼rdÃ¼rÃ¼lÃ¼yor
...
#define MSG_ERR_Z_HOMING                    _UxGT("G28 Z YapÄ±lamaz")                                    // G28 Z YapÄ±lamaz
...
#define MSG_HEATING_COMPLETE                _UxGT("IsÄ±nma tamam.")                                      // IsÄ±nma tamam.
#define MSG_BED_HEATING                     _UxGT("Tabla IsÄ±nÄ±yor.")                                    // Tabla IsÄ±nÄ±yor.
#define MSG_BED_DONE                        _UxGT("Tabla hazÄ±r.")                                       // Tabla hazÄ±r.
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Daha AkÄ±t")                                          // Daha AkÄ±t
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("BaskÄ±yÄ± sÃ¼rdÃ¼r")                                     // BaskÄ±yÄ± sÃ¼rdÃ¼r
#define MSG_FILAMENT_CHANGE_MINTEMP         _UxGT("Min. SÄ±caklÄ±k")                                      // Min. SÄ±caklÄ±k:
#define MSG_FILAMENT_CHANGE_NOZZLE          _UxGT("  NozÃ¼l: ")                                          //   NozÃ¼l:
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("filaman akmasÄ±")                                   // filaman akmasÄ±
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("AkÄ±tÄ±lÄ±yor...")                                    // AkÄ±tÄ±lÄ±yor...
