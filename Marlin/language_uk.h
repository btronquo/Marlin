...
#define MSG_VX_JERK                         _UxGT("Vx-Ñ€Ð¸Ð²Ð¾Ðº")
#define MSG_VY_JERK                         _UxGT("Vy-Ñ€Ð¸Ð²Ð¾Ðº")
#define MSG_VZ_JERK                         _UxGT("Vz-Ñ€Ð¸Ð²Ð¾Ðº")
...
#define MSG_XSTEPS                          _UxGT("XÐºÑ€Ð¾ÐºÑ–Ð²/Ð¼Ð¼")
#define MSG_YSTEPS                          _UxGT("YÐºÑ€Ð¾ÐºÑ–Ð²/Ð¼Ð¼")
#define MSG_ZSTEPS                          _UxGT("ZÐºÑ€Ð¾ÐºÑ–Ð²/Ð¼Ð¼")
...
#define MSG_RESUMING                        _UxGT("Ð’Ñ–Ð´Ð½Ð¾Ð²Ð»ÐµÐ½Ð½Ñ� Ð´Ñ€ÑƒÐºÑƒ")
...
#define MSG_ERR_Z_HOMING                    _UxGT("G28 Z Ð’Ñ–Ð´Ð¼Ð¾Ð²Ð»ÐµÐ½Ð¾")
...
#define MSG_HEATING_COMPLETE                _UxGT("Ð�Ð°Ð³Ñ€Ñ–Ñ‚Ð¾.")
#define MSG_BED_HEATING                     _UxGT("Ð�Ð°Ð³Ñ€Ñ–Ð²Ð°Ð½Ð½Ñ� Ñ�Ñ‚Ð¾Ð»Ñƒ.")
#define MSG_BED_DONE                        _UxGT("Ð¡Ñ‚Ñ–Ð» Ð½Ð°Ð³Ñ€Ñ–Ñ‚Ð¸Ð¹.")
...
#define MSG_FILAMENT_CHANGE_OPTION_EXTRUDE  _UxGT("Ð•ÐºÑ�Ñ‚Ñ€ÑƒÐ´ÑƒÐ²Ð°Ñ‚Ð¸")
#define MSG_FILAMENT_CHANGE_OPTION_RESUME   _UxGT("Ð’Ñ–Ð´Ð½Ð¾Ð²Ð¸Ñ‚Ð¸ Ð´Ñ€ÑƒÐº")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Ð—Ð°Ñ‡ÐµÐºÐ°Ð¹Ñ‚Ðµ Ð½Ð°")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_2       _UxGT("ÐµÐºÑ�Ñ‚Ñ€ÑƒÐ·Ñ–ÑŽ")
  #define MSG_FILAMENT_CHANGE_EXTRUDE_3       _UxGT("Ð²Ð¾Ð»Ð¾ÐºÐ½Ð°")
  ...
  #define MSG_FILAMENT_CHANGE_EXTRUDE_1       _UxGT("Ð•ÐºÑ�Ñ‚Ñ€ÑƒÐ·Ñ–Ñ�...")
