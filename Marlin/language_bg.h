...
#define MSG_XSTEPS                          _UxGT("X Ñ�Ñ‚ÑŠÐ¿ÐºÐ¸/mm")
#define MSG_YSTEPS                          _UxGT("Y Ñ�Ñ‚ÑŠÐ¿ÐºÐ¸/mm")
#define MSG_ZSTEPS                          _UxGT("Z Ñ�Ñ‚ÑŠÐ¿ÐºÐ¸/mm")
...
#define MSG_RESUMING                        _UxGT("ÐŸÑ€Ð¾Ð´ÑŠÐ»Ð¶. Ð¿ÐµÑ‡Ð°Ñ‚Ð°")
